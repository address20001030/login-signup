...
public class UserController {
    ...
    public ResponseEntity<BaseResponse<UserResponse>> updateUser(@PathVariable long id, @RequestBody UseSaveOrUpdateRequest saveOrUpdateRequest){
        userService.update(id,saveOrUpdateRequest);
        return ResponseEntity.ok(BaseResponse.ofSuccess(null));
    }

    @DeleteMapping("/user/delete/{id}")
    public ResponseEntity<BaseResponse<UserResponse>> deleteUser(@PathVariable long id){
